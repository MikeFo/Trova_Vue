export const environment = {
  ...
  oidcConfig: {
    ...
    redirect_url: 'https://vue.trova-staging.com/login/callback',
  ...
  siteUrl: 'https://vue.trova-staging.com',
